...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dim"    , type=int   , help="model dimmention"                              , default=512)
    parser.add_argument("--num_special_tokens_trg"    , type=int   , help="number of special tokens of target"                              , default=512)
